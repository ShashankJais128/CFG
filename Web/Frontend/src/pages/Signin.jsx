  ...
  return (
    <div className='flex justify-center items-center h-[90vh]'>
      <div className='flex flex-col justify-center items-center bg-gray-300 border-2 border-gray-500 p-5 sm:p-10 rounded-xl backdrop-blur-2xl'>
        ...
        <h1 className='text-3xl font-bold'>Login to Name</h1><br /><br />
        ...
        <button className='w-[200px] bg-gray-500 text-lg rounded p-1.5 font-bold'><Link to='/signin'>Log in</Link></button>
      </div>
    </div>
  )
}
